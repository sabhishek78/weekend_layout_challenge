...
// Sending a POST request with headers
    ...
    http.Response response = await http.post(url,
        headers: headers,
        body: jsonEncode({"customerName": customerName, "password": password}));
    ...
    String sessionCookieSig = extractSessionCookie(
        "session.sig=", response.headers["set-cookie"].toString());
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => CustomerPage(
                  ...
                  sessionCookieSig: sessionCookieSig,
                )));
  }
...
//                    mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  color:
                      HSLColor.fromAHSL(1.0, 154, 0.55, 0.51).toColor(),
                  shape: RoundedRectangleBorder(
